...
static TestBindings_wrappersNS::QObject_wrapper *fromWrapperPtr(void *ptr)
{
    return reinterpret_cast<TestBindings_wrappersNS::QObject_wrapper *>(ptr);
}
extern "C" {
void c_QObject_Finalizer(void *cppObj)
{
    delete reinterpret_cast<TestBindings_wrappersNS::QObject_wrapper *>(cppObj);
}
void *c_QObject__constructor_QObject(void *parent_)
{
    auto parent = reinterpret_cast<QObject *>(parent_);
    auto ptr = new TestBindings_wrappersNS::QObject_wrapper(parent);
                                                            ...
                                                            void *receiver_, const char *member)
{
    ...
    auto receiver = reinterpret_cast<QObject *>(receiver_);
    const auto &result =
        TestBindings_wrappersNS::QObject_wrapper::disconnect(sender, signal, receiver, member);
    free(( char * )signal);
    free(( char * )member);
    return result;
}
...
bool c_QObject__event_QEvent(void *thisObj, void *event_)
{
    ...
    const auto &result = [&] {
        ...
        auto wrapperPtr = dynamic_cast<TestBindings_wrappersNS::QObject_wrapper *>(targetPtr);
        if (wrapperPtr) {
...
{
    const auto &result = new Dartagnan::ValueWrapper<QVariant> { fromPtr(thisObj)->property(name) };
    free(( char * )name);
    return result;
}
...
{
    const auto &result =
        new Dartagnan::ValueWrapper<QString> { TestBindings_wrappersNS::QObject_wrapper::tr(s, c,
                                                                                            n) };
    free(( char * )s);
    free(( char * )c);
    return result;
...
void c_QObject__registerVirtualMethodCallback(void *ptr, void *callback, int methodId)
{
    ...
    case 481:
        wrapper->m_customEventCallback =
            reinterpret_cast<TestBindings_wrappersNS::QObject_wrapper::Callback_customEvent>(
                callback);
        break;
    case 490:
        wrapper->m_eventCallback =
            reinterpret_cast<TestBindings_wrappersNS::QObject_wrapper::Callback_event>(callback);
        break;
    case 491:
        wrapper->m_eventFilterCallback =
            reinterpret_cast<TestBindings_wrappersNS::QObject_wrapper::Callback_eventFilter>(
                callback);
        break;
    }
}
