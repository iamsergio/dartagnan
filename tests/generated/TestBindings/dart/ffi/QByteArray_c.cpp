...
QByteArray &QByteArray_wrapper::replace(const char *before, qsizetype bsize, const char *after,
                                        qsizetype asize)
{
    return ::QByteArray::replace(before, bsize, after, asize);
}
QByteArray &QByteArray_wrapper::replace(qsizetype index, qsizetype len, const char *s,
                                        qsizetype alen)
{
...
static TestBindings_wrappersNS::QByteArray_wrapper *fromWrapperPtr(void *ptr)
{
    return reinterpret_cast<TestBindings_wrappersNS::QByteArray_wrapper *>(ptr);
}
extern "C" {
void c_QByteArray_Finalizer(void *cppObj)
{
    delete reinterpret_cast<TestBindings_wrappersNS::QByteArray_wrapper *>(cppObj);
}
void *c_QByteArray__constructor()
{
    auto ptr = new TestBindings_wrappersNS::QByteArray_wrapper();
    return reinterpret_cast<void *>(ptr);
}
void *c_QByteArray__constructor_char_qsizetype(const char *arg__1, qsizetype size)
{
    auto ptr = new TestBindings_wrappersNS::QByteArray_wrapper(arg__1, size);
    return reinterpret_cast<void *>(ptr);
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> { fromPtr(thisObj)->chopped(len) };
    return result;
}
// clear()
...
{
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> { fromPtr(thisObj)->first(n) };
    return result;
}
...
void *c_static_QByteArray__fromBase64_QByteArray(void *base64_)
{
    ...
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> {
        TestBindings_wrappersNS::QByteArray_wrapper::fromBase64(base64)
    };
    return result;
}
...
void *c_static_QByteArray__fromHex_QByteArray(void *hexEncoded_)
{
    ...
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> {
        TestBindings_wrappersNS::QByteArray_wrapper::fromHex(hexEncoded)
    };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> {
        TestBindings_wrappersNS::QByteArray_wrapper::fromRawData(data, size)
    };
    free(( char * )data);
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> { fromPtr(thisObj)->last(n) };
    return result;
}
// left(qsizetype len) const
void *c_QByteArray__left_qsizetype(void *thisObj, qsizetype len)
{
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> { fromPtr(thisObj)->left(len) };
    return result;
}
// length() const
...
{
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> {
        TestBindings_wrappersNS::QByteArray_wrapper::number(arg__1, base)
    };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> { fromPtr(thisObj)->right(len) };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> { fromPtr(thisObj)->simplified() };
    return result;
}
// size() const
...
{
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> { fromPtr(thisObj)->sliced(pos) };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> { fromPtr(thisObj)->toBase64() };
    return result;
}
// toLower()
void *c_QByteArray__toLower(void *thisObj)
{
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> { fromPtr(thisObj)->toLower() };
    return result;
}
// toUpper()
void *c_QByteArray__toUpper(void *thisObj)
{
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> { fromPtr(thisObj)->toUpper() };
    return result;
}
// trimmed()
void *c_QByteArray__trimmed(void *thisObj)
{
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> { fromPtr(thisObj)->trimmed() };
    return result;
}
