...
QColor_wrapper::QColor_wrapper(const QString &name)
    : ::QColor(name)
{
}
QColor_wrapper::QColor_wrapper(const char *aname)
    : ::QColor(aname)
{
}
...
static QColor *fromPtr(void *ptr)
{
    return reinterpret_cast<QColor *>(ptr);
}
static TestBindings_wrappersNS::QColor_wrapper *fromWrapperPtr(void *ptr)
{
    return reinterpret_cast<TestBindings_wrappersNS::QColor_wrapper *>(ptr);
}
extern "C" {
void c_QColor_Finalizer(void *cppObj)
{
    delete reinterpret_cast<TestBindings_wrappersNS::QColor_wrapper *>(cppObj);
}
void *c_QColor__constructor()
{
    auto ptr = new TestBindings_wrappersNS::QColor_wrapper();
    return reinterpret_cast<void *>(ptr);
}
void *c_QColor__constructor_QString(const char *name_)
{
    const auto name = QString::fromUtf8(name_);
    auto ptr = new TestBindings_wrappersNS::QColor_wrapper(name);
    return reinterpret_cast<void *>(ptr);
}
void *c_QColor__constructor_char(const char *aname)
{
    auto ptr = new TestBindings_wrappersNS::QColor_wrapper(aname);
    return reinterpret_cast<void *>(ptr);
}
void *c_QColor__constructor_int_int_int_int(int r, int g, int b, int a)
{
    auto ptr = new TestBindings_wrappersNS::QColor_wrapper(r, g, b, a);
    return reinterpret_cast<void *>(ptr);
}
// alpha() const
...
void *c_static_QColor__colorNames()
{
    const auto &result = new Dartagnan::ValueWrapper<QList<QString>> {
        TestBindings_wrappersNS::QColor_wrapper::colorNames()
    };
    return result;
}
// cyan() const
...
{
    const auto &result = new Dartagnan::ValueWrapper<QColor> { fromPtr(thisObj)->darker(f) };
    return result;
}
...
void *c_static_QColor__fromCmyk_int_int_int_int_int(int c, int m, int y, int k, int a)
{
    const auto &result = new Dartagnan::ValueWrapper<QColor> {
        TestBindings_wrappersNS::QColor_wrapper::fromCmyk(c, m, y, k, a)
    };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QColor> {
        TestBindings_wrappersNS::QColor_wrapper::fromCmykF(c, m, y, k, a)
    };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QColor> {
        TestBindings_wrappersNS::QColor_wrapper::fromHsl(h, s, l, a)
    };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QColor> {
        TestBindings_wrappersNS::QColor_wrapper::fromHslF(h, s, l, a)
    };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QColor> {
        TestBindings_wrappersNS::QColor_wrapper::fromHsv(h, s, v, a)
    };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QColor> {
        TestBindings_wrappersNS::QColor_wrapper::fromHsvF(h, s, v, a)
    };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QColor> {
        TestBindings_wrappersNS::QColor_wrapper::fromRgb(r, g, b, a)
    };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QColor> {
        TestBindings_wrappersNS::QColor_wrapper::fromRgbF(r, g, b, a)
    };
    return result;
}
// green() const
...
{
    const auto name = QString::fromUtf8(name_);
    const auto &result = TestBindings_wrappersNS::QColor_wrapper::isValidColor(name);
    free(( char * )name_);
    return result;
}
// lighter(int f) const
...
{
    const auto &result = new Dartagnan::ValueWrapper<QColor> { fromPtr(thisObj)->lighter(f) };
    return result;
}
// lightness() const
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> { fromPtr(thisObj)->name() };
    return result;
}
// red() const
...
{
    const auto &result = new Dartagnan::ValueWrapper<QColor> { fromPtr(thisObj)->toCmyk() };
    return result;
}
// toExtendedRgb() const
void *c_QColor__toExtendedRgb(void *thisObj)
{
    const auto &result = new Dartagnan::ValueWrapper<QColor> { fromPtr(thisObj)->toExtendedRgb() };
    return result;
}
// toHsl() const
void *c_QColor__toHsl(void *thisObj)
{
    const auto &result = new Dartagnan::ValueWrapper<QColor> { fromPtr(thisObj)->toHsl() };
    return result;
}
// toHsv() const
void *c_QColor__toHsv(void *thisObj)
{
    const auto &result = new Dartagnan::ValueWrapper<QColor> { fromPtr(thisObj)->toHsv() };
    return result;
}
// toRgb() const
void *c_QColor__toRgb(void *thisObj)
{
    const auto &result = new Dartagnan::ValueWrapper<QColor> { fromPtr(thisObj)->toRgb() };
    return result;
}
// value() const
