...
QString_wrapper::QString_wrapper(const QByteArray &a)
    : ::QString(a)
{
}
QString_wrapper::QString_wrapper(const char *ch)
    : ::QString(ch)
{
}
...
static TestBindings_wrappersNS::QString_wrapper *fromWrapperPtr(void *ptr)
{
    return reinterpret_cast<TestBindings_wrappersNS::QString_wrapper *>(ptr);
}
extern "C" {
void c_QString_Finalizer(void *cppObj)
{
    delete reinterpret_cast<TestBindings_wrappersNS::QString_wrapper *>(cppObj);
}
void *c_QString__constructor()
{
    auto ptr = new TestBindings_wrappersNS::QString_wrapper();
...
void *c_QString__constructor_QByteArray(void *a_)
{
    ...
    auto ptr = new TestBindings_wrappersNS::QString_wrapper(a);
    return reinterpret_cast<void *>(ptr);
}
void *c_QString__constructor_char(const char *ch)
{
    auto ptr = new TestBindings_wrappersNS::QString_wrapper(ch);
    return reinterpret_cast<void *>(ptr);
}
...
void *c_static_QString__asprintf_char(const char *format)
{
    const auto &result = new Dartagnan::ValueWrapper<QString> {
        TestBindings_wrappersNS::QString_wrapper::asprintf(format)
    };
    free(( char * )format);
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> { fromPtr(thisObj)->chopped(n) };
    return result;
}
// clear()
...
int c_static_QString__compare_QString_QString(const char *s1_, const char *s2_)
{
    ...
    const auto &result = TestBindings_wrappersNS::QString_wrapper::compare(s1, s2);
    free(( char * )s1_);
    free(( char * )s2_);
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> { fromPtr(thisObj)->first(n) };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> {
        TestBindings_wrappersNS::QString_wrapper::fromLatin1(str, size)
    };
    free(( char * )str);
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> {
        TestBindings_wrappersNS::QString_wrapper::fromLocal8Bit(str, size)
    };
    free(( char * )str);
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> {
        TestBindings_wrappersNS::QString_wrapper::fromUtf8(utf8, size)
    };
    free(( char * )utf8);
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> { fromPtr(thisObj)->last(n) };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> { fromPtr(thisObj)->left(n) };
    return result;
}
...
int c_static_QString__localeAwareCompare_QString_QString(const char *s1_, const char *s2_)
{
    const auto s1 = QString::fromUtf8(s1_);
    const auto s2 = QString::fromUtf8(s2_);
    const auto &result = TestBindings_wrappersNS::QString_wrapper::localeAwareCompare(s1, s2);
    free(( char * )s1_);
    free(( char * )s2_);
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> {
        TestBindings_wrappersNS::QString_wrapper::number(arg__1, base)
    };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> { fromPtr(thisObj)->repeated(times) };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> { fromPtr(thisObj)->right(n) };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> { fromPtr(thisObj)->simplified() };
    return result;
}
// size() const
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> { fromPtr(thisObj)->sliced(pos) };
    return result;
}
// sliced(qsizetype pos, qsizetype n) const
void *c_QString__sliced_qsizetype_qsizetype(void *thisObj, qsizetype pos, qsizetype n)
{
    const auto &result = new Dartagnan::ValueWrapper<QString> { fromPtr(thisObj)->sliced(pos, n) };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> { fromPtr(thisObj)->toCaseFolded() };
    return result;
}
// toHtmlEscaped() const
void *c_QString__toHtmlEscaped(void *thisObj)
{
    const auto &result = new Dartagnan::ValueWrapper<QString> { fromPtr(thisObj)->toHtmlEscaped() };
    return result;
}
// toLatin1()
void *c_QString__toLatin1(void *thisObj)
{
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> { fromPtr(thisObj)->toLatin1() };
    return result;
}
// toLocal8Bit()
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> { fromPtr(thisObj)->toLower() };
    return result;
}
// toUcs4() const
...
{
    const auto &result =
        new Dartagnan::ValueWrapper<QList<unsigned int>> { fromPtr(thisObj)->toUcs4() };
    return result;
}
// toUpper()
void *c_QString__toUpper(void *thisObj)
{
    const auto &result = new Dartagnan::ValueWrapper<QString> { fromPtr(thisObj)->toUpper() };
    return result;
}
// toUtf8()
void *c_QString__toUtf8(void *thisObj)
{
    const auto &result = new Dartagnan::ValueWrapper<QByteArray> { fromPtr(thisObj)->toUtf8() };
    return result;
}
// trimmed()
void *c_QString__trimmed(void *thisObj)
{
    const auto &result = new Dartagnan::ValueWrapper<QString> { fromPtr(thisObj)->trimmed() };
    return result;
}
