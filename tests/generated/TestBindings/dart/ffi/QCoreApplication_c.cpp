...
bool QCoreApplication_wrapper::eventFilter_nocallback(QObject *watched, QEvent *event)
{
    return ::QCoreApplication::eventFilter(watched, event);
}
...
bool QCoreApplication_wrapper::notify_nocallback(QObject *arg__1, QEvent *arg__2)
{
    return ::QCoreApplication::notify(arg__1, arg__2);
}
...
void QCoreApplication_wrapper::postEvent(QObject *receiver, QEvent *event, int priority)
{
...
void QCoreApplication_wrapper::removePostedEvents(QObject *receiver, int eventType)
{
...
void QCoreApplication_wrapper::sendPostedEvents(QObject *receiver, int event_type)
{
...
QString QCoreApplication_wrapper::translate(const char *context, const char *key,
...
static TestBindings_wrappersNS::QCoreApplication_wrapper *fromWrapperPtr(void *ptr)
{
    return reinterpret_cast<TestBindings_wrappersNS::QCoreApplication_wrapper *>(ptr);
}
extern "C" {
void c_QCoreApplication_Finalizer(void *cppObj)
{
    delete reinterpret_cast<TestBindings_wrappersNS::QCoreApplication_wrapper *>(cppObj);
...
void c_static_QCoreApplication__addLibraryPath_QString(const char *arg__1_)
{
    ...
    TestBindings_wrappersNS::QCoreApplication_wrapper::addLibraryPath(arg__1);
    free(( char * )arg__1_);
}
// applicationDirPath()
void *c_static_QCoreApplication__applicationDirPath()
{
    const auto &result = new Dartagnan::ValueWrapper<QString> {
        TestBindings_wrappersNS::QCoreApplication_wrapper::applicationDirPath()
    };
    return result;
}
// applicationFilePath()
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> {
        TestBindings_wrappersNS::QCoreApplication_wrapper::applicationFilePath()
    };
    return result;
}
// applicationName()
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> {
        TestBindings_wrappersNS::QCoreApplication_wrapper::applicationName()
    };
    return result;
}
...
void c_QCoreApplication__onApplicationNameChanged(void *thisObj, void *contextQObject,
                                                  void *callback)
{
...
{
    const auto &result = TestBindings_wrappersNS::QCoreApplication_wrapper::applicationPid();
    return result;
}
// applicationVersion()
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> {
        TestBindings_wrappersNS::QCoreApplication_wrapper::applicationVersion()
    };
    return result;
}
...
void c_QCoreApplication__onApplicationVersionChanged(void *thisObj, void *contextQObject,
                                                     void *callback)
{
    auto instance = reinterpret_cast<QCoreApplication *>(thisObj);
    auto context = reinterpret_cast<QObject *>(contextQObject);
...
void *c_static_QCoreApplication__arguments()
{
    const auto &result = new Dartagnan::ValueWrapper<QList<QString>> {
        TestBindings_wrappersNS::QCoreApplication_wrapper::arguments()
    };
    return result;
}
// closingDown()
...
{
    const auto &result = TestBindings_wrappersNS::QCoreApplication_wrapper::closingDown();
    return result;
}
...
void c_QCoreApplication__onDestroyed_QObject(void *thisObj, void *contextQObject, void *callback)
{
    auto instance = reinterpret_cast<QCoreApplication *>(thisObj);
    auto context = reinterpret_cast<QObject *>(contextQObject);
    QObject::connect(instance, &QCoreApplication::destroyed, context ? context : instance,
                     [thisObj, callback] {
                         typedef void (*SignalHandler_callback)(void *);
                         auto dartCallback = reinterpret_cast<SignalHandler_callback>(callback);
                         dartCallback(thisObj);
...
bool c_QCoreApplication__eventFilter_QObject_QEvent(void *thisObj, void *watched_, void *event_)
{
    ...
    const auto &result = [&] {
        ...
        auto wrapperPtr =
            dynamic_cast<TestBindings_wrappersNS::QCoreApplication_wrapper *>(targetPtr);
        if (wrapperPtr) {
...
{
    const auto &result = TestBindings_wrappersNS::QCoreApplication_wrapper::exec();
    return result;
}
// exit(int retcode)
void c_static_QCoreApplication__exit_int(int retcode)
{
    TestBindings_wrappersNS::QCoreApplication_wrapper::exit(retcode);
}
// instance()
void *c_static_QCoreApplication__instance()
{
    const auto &result = TestBindings_wrappersNS::QCoreApplication_wrapper::instance();
    return result;
}
// isQuitLockEnabled()
bool c_static_QCoreApplication__isQuitLockEnabled()
{
    const auto &result = TestBindings_wrappersNS::QCoreApplication_wrapper::isQuitLockEnabled();
    return result;
}
// isSetuidAllowed()
bool c_static_QCoreApplication__isSetuidAllowed()
{
    const auto &result = TestBindings_wrappersNS::QCoreApplication_wrapper::isSetuidAllowed();
    return result;
}
// libraryPaths()
...
{
    const auto &result = new Dartagnan::ValueWrapper<QList<QString>> {
        TestBindings_wrappersNS::QCoreApplication_wrapper::libraryPaths()
    };
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> {
        TestBindings_wrappersNS::QCoreApplication_wrapper::organizationDomain()
    };
    return result;
}
...
void c_QCoreApplication__onOrganizationDomainChanged(void *thisObj, void *contextQObject,
                                                     void *callback)
{
    auto instance = reinterpret_cast<QCoreApplication *>(thisObj);
    auto context = reinterpret_cast<QObject *>(contextQObject);
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> {
        TestBindings_wrappersNS::QCoreApplication_wrapper::organizationName()
    };
    return result;
}
                                                             ...
                                                             int priority)
{
    ...
    auto event = reinterpret_cast<QEvent *>(event_);
    TestBindings_wrappersNS::QCoreApplication_wrapper::postEvent(receiver, event, priority);
}
// processEvents()
void c_static_QCoreApplication__processEvents()
{
    TestBindings_wrappersNS::QCoreApplication_wrapper::processEvents();
}
// quit()
void c_static_QCoreApplication__quit()
{
    TestBindings_wrappersNS::QCoreApplication_wrapper::quit();
}
// removeLibraryPath(const QString & arg__1)
void c_static_QCoreApplication__removeLibraryPath_QString(const char *arg__1_)
{
    const auto arg__1 = QString::fromUtf8(arg__1_);
    TestBindings_wrappersNS::QCoreApplication_wrapper::removeLibraryPath(arg__1);
    free(( char * )arg__1_);
}
...
{
    auto receiver = reinterpret_cast<QObject *>(receiver_);
    TestBindings_wrappersNS::QCoreApplication_wrapper::removePostedEvents(receiver, eventType);
}
...
bool c_static_QCoreApplication__sendEvent_QObject_QEvent(void *receiver_, void *event_)
{
    ...
    auto event = reinterpret_cast<QEvent *>(event_);
    const auto &result =
        TestBindings_wrappersNS::QCoreApplication_wrapper::sendEvent(receiver, event);
    return result;
}
...
{
    auto receiver = reinterpret_cast<QObject *>(receiver_);
    TestBindings_wrappersNS::QCoreApplication_wrapper::sendPostedEvents(receiver, event_type);
}
...
void c_static_QCoreApplication__setApplicationName_QString(const char *application_)
{
    ...
    TestBindings_wrappersNS::QCoreApplication_wrapper::setApplicationName(application);
...
void c_static_QCoreApplication__setApplicationVersion_QString(const char *version_)
{
    ...
    TestBindings_wrappersNS::QCoreApplication_wrapper::setApplicationVersion(version);
    free(( char * )version_);
}
...
void c_static_QCoreApplication__setLibraryPaths_QList_QString(void *arg__1_)
{
    ...
    TestBindings_wrappersNS::QCoreApplication_wrapper::setLibraryPaths(arg__1);
}
...
void c_static_QCoreApplication__setOrganizationDomain_QString(const char *orgDomain_)
{
    ...
    TestBindings_wrappersNS::QCoreApplication_wrapper::setOrganizationDomain(orgDomain);
...
void c_static_QCoreApplication__setOrganizationName_QString(const char *orgName_)
{
    ...
    TestBindings_wrappersNS::QCoreApplication_wrapper::setOrganizationName(orgName);
    free(( char * )orgName_);
}
// setQuitLockEnabled(bool enabled)
void c_static_QCoreApplication__setQuitLockEnabled_bool(bool enabled)
{
    TestBindings_wrappersNS::QCoreApplication_wrapper::setQuitLockEnabled(enabled);
}
// setSetuidAllowed(bool allow)
void c_static_QCoreApplication__setSetuidAllowed_bool(bool allow)
{
    TestBindings_wrappersNS::QCoreApplication_wrapper::setSetuidAllowed(allow);
}
// startingUp()
bool c_static_QCoreApplication__startingUp()
{
    const auto &result = TestBindings_wrappersNS::QCoreApplication_wrapper::startingUp();
    return result;
}
...
{
    const auto &result = new Dartagnan::ValueWrapper<QString> {
        TestBindings_wrappersNS::QCoreApplication_wrapper::tr(s, c, n)
    };
    free(( char * )s);
    free(( char * )c);
    return result;
}
// translate(const char * context, const char * key, const char * disambiguation, int n)
void *c_static_QCoreApplication__translate_char_char_char_int(const char *context, const char *key,
                                                              const char *disambiguation, int n)
{
    const auto &result = new Dartagnan::ValueWrapper<QString> {
        TestBindings_wrappersNS::QCoreApplication_wrapper::translate(context, key, disambiguation,
                                                                     n)
    };
    free(( char * )context);
    free(( char * )key);
...
void c_QCoreApplication__registerVirtualMethodCallback(void *ptr, void *callback, int methodId)
{
    ...
    case 481:
        wrapper->m_customEventCallback = reinterpret_cast<
            TestBindings_wrappersNS::QCoreApplication_wrapper::Callback_customEvent>(callback);
        break;
    case 490:
        wrapper->m_eventCallback =
            reinterpret_cast<TestBindings_wrappersNS::QCoreApplication_wrapper::Callback_event>(
                callback);
        break;
    case 491:
        wrapper->m_eventFilterCallback = reinterpret_cast<
            TestBindings_wrappersNS::QCoreApplication_wrapper::Callback_eventFilter>(callback);
        break;
    case 688:
        wrapper->m_notifyCallback =
            reinterpret_cast<TestBindings_wrappersNS::QCoreApplication_wrapper::Callback_notify>(
                callback);
        break;
    }
}
