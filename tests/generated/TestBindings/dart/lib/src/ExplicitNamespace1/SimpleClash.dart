...
class SimpleClash implements ffi.Finalizable {
  ...
  String getFinalizerName() {
    return "c_NameClashingNS1__SimpleClash_Finalizer";
  } //SimpleClash(int arg__1)

  SimpleClash(int arg__1) {
    final voidstar_Func_int func = _dylib
        .lookup<ffi.NativeFunction<voidstar_Func_ffi_Int32_FFI>>(
            'c_NameClashingNS1__SimpleClash__constructor_int')
        .asFunction();
    thisCpp = func(arg__1);
    ExplicitNamespace1.SimpleClash.s_dartInstanceByCppPtr[thisCpp.address] =
        this;
  } // getValue()
  int getValue() {
    final int_Func_voidstar func = _dylib
        .lookup<ffi.NativeFunction<int_Func_voidstar_FFI>>(
            'c_NameClashingNS1__SimpleClash__getValue')
        .asFunction();
    return func(thisCpp);
  }
  ...
  static // getValueStatic()
    ...
    final int_Func_void func = _dylib
        .lookup<ffi.NativeFunction<int_Func_void_FFI>>(
            'c_static_NameClashingNS1__SimpleClash__getValueStatic')
        .asFunction();
    return func();
  }
  ...
  void release() {
    final void_Func_voidstar func = _dylib
        .lookup<ffi.NativeFunction<void_Func_voidstar_FFI>>(
            'c_NameClashingNS1__SimpleClash__destructor')
        .asFunction();
    func(thisCpp);
  }
}
