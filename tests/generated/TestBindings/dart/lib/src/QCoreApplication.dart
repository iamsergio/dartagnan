...
class QCoreApplication extends QObject {
  // Anonymous enum
  static const ApplicationFlags = 393985;
  ...
  static // sendPostedEvents(QObject * receiver, int event_type)
      sendPostedEvents({QObject? receiver, int event_type = 0}) {
    final void_Func_voidstar_int func = _dylib
        .lookup<ffi.NativeFunction<void_Func_voidstar_ffi_Int32_FFI>>(
  ...
  void registerCallbacks() {
    ...
    final callback490 =
        ffi.Pointer.fromFunction<bool_Func_voidstar_voidstar_FFI>(
            QCoreApplication.event_calledFromC, callbackExcept490);
    ...
    final callback688 =
        ffi.Pointer.fromFunction<bool_Func_voidstar_voidstar_voidstar_FFI>(
            QCoreApplication.notify_calledFromC, callbackExcept688);
