...
class QString implements ffi.Finalizable {
  ...
  QString arg(String a, {int fieldWidth = 0}) {
    final voidstar_Func_voidstar_voidstar_int func = _dylib
        ...
        .asFunction();
    ffi.Pointer<void> result = func(thisCpp, a.toNativeUtf8(), fieldWidth);
  ...
  int compare(String s) {
    final int_Func_voidstar_voidstar func = _dylib
        ...
        .asFunction();
    return func(thisCpp, s.toNativeUtf8());
  }
  ...
  static // compare(const QString & s1, const QString & s2)
    ...
    final int_Func_voidstar_voidstar func = _dylib
        ...
        .asFunction();
    return func(s1.toNativeUtf8(), s2.toNativeUtf8());
  ...
  bool contains(String s) {
    final bool_Func_voidstar_voidstar func = _dylib
        ...
        .asFunction();
    return func(thisCpp, s.toNativeUtf8()) != 0;
  } // count() const
  ...
  int indexOf(String s, {int from = 0}) {
    final int_Func_voidstar_voidstar_int func = _dylib
        ...
        .asFunction();
    return func(thisCpp, s.toNativeUtf8(), from);
  ...
  QString insert_2(int i, String s) {
    final voidstar_Func_voidstar_int_voidstar func = _dylib
        ...
        .asFunction();
    ffi.Pointer<void> result = func(thisCpp, i, s.toNativeUtf8());
    return QString.fromCppPointer(result, false);
  ...
  bool isSharedWith(String other) {
    final bool_Func_voidstar_voidstar func = _dylib
        ...
        .asFunction();
    return func(thisCpp, other.toNativeUtf8()) != 0;
  } // isSimpleText() const
  ...
  QString replace(String before, String after) {
    final voidstar_Func_voidstar_voidstar_voidstar func = _dylib
        ...
        .asFunction();
    ffi.Pointer<void> result =
        func(thisCpp, before.toNativeUtf8(), after.toNativeUtf8());
    return QString.fromCppPointer(result, false);
  ...
  QString replace_2(int i, int len, String after) {
    final voidstar_Func_voidstar_int_int_voidstar func = _dylib
        ...
        .asFunction();
    ffi.Pointer<void> result = func(thisCpp, i, len, after.toNativeUtf8());
    return QString.fromCppPointer(result, false);
  ...
  QString section(String in_sep, int start, {int end = -1}) {
    final voidstar_Func_voidstar_voidstar_int_int func = _dylib
        ...
        .asFunction();
    ffi.Pointer<void> result = func(thisCpp, in_sep.toNativeUtf8(), start, end);
    return QString.fromCppPointer(result, true);
  ...
  static // simplified_helper(QString & str)
    ...
    final voidstar_Func_voidstar func = _dylib
        ...
        .asFunction();
    ffi.Pointer<void> result = func(str.toNativeUtf8());
    return QString.fromCppPointer(result, true);
  }
  ...
  QList split(String sep) {
    final voidstar_Func_voidstar_voidstar func = _dylib
        ...
        .asFunction();
    ffi.Pointer<void> result = func(thisCpp, sep.toNativeUtf8());
  ...
  static // toLatin1_helper(const QString & arg__1)
    ...
    final voidstar_Func_voidstar func = _dylib
        ...
        .asFunction();
    ffi.Pointer<void> result = func(arg__1.toNativeUtf8());
    return QByteArray.fromCppPointer(result, true);
  }
